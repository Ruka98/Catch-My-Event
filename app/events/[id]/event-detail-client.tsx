              ...
              <CardContent>
                <div className="flex items-center space-x-3">
                  <Avatar className="w-10 h-10">
                    ...
                    <AvatarFallback>{event.profiles.display_name.charAt(0).toUpperCase()}</AvatarFallback>
                  </Avatar>
                  <div>
                    <p className="font-medium text-gray-900 text-sm">{event.profiles.display_name}</p>
                    <div className="flex items-center">
